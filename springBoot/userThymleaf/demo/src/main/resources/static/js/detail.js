...
const URL_GET_USER = `/api/v1/users/${id}`
const URL_UPDATE_USER = `/api/v1/users/${id}`

const URL_UPDATE_PASS = `/api/v1/users/${id}/update-password`
const URL_FORGOT_PASS = `/api/v1/users/${id}/forgot-password`


const URL_GET_IMG = `/api/v1/users/${id}/files`
const URL_POST_IMG = `/api/v1/users/${id}/upload-file`
